...
class ponggame(Widget):
    ...
    def increase_ball_speed(self, dt):
        ...
        logging.info("In ponggame - increase_ball_speed(), speed factor: " + str(self.ball.speed_factor))
    ...
    def move_paddle_downward(self, keycode):
        ...
        if(keycode == "down"):
            logging.info("In ponggame - move_paddle_downward(), key code: " + keycode + ".  player 2 y position:" + str(self.player2.center_y - self.paddle_speed))
    ...
    def update(self, dt):
        ...
        for key in self.pressed_keys:
            try:
                ...
                logging.error("In ponggame - update(), System encountered a possible key error. " + str(key)) + ".  Player might be alt-tab to other screen." 
        
        
        self.ball.move()

        # bounce ball off paddles
        self.player1.bounce_ball(self.ball, self.ball.speed_factor)
        self.player2.bounce_ball(self.ball, self.ball.speed_factor)
    ...
    def _on_keyboard_down(self, keyboard, keycode, text, modifiers):
       ...
       logging.info("In ponggame - _on_keyboard_down(), screen height: " + str(self.height))
